...
function Landing() {
    ...
    return (
            ...
            <div className="col-md-10 col-sm-12 p-0 mb-3">
                ...
                <img src={require("../pages/Images/aws-certified-solutions-architect-associate.png")} alt="Banner" ></img>
                <img src={require("../pages/Images/cert_mark_SP_small_150px.png")} alt="Banner" ></img>
                <img src={require("../pages/Images/hashicorp-certified-terraform-associate.png")} alt="Banner" ></img>
